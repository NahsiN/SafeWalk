...
g = nx.read_shp('data/cal/tl_2013_06_prisecroads.shp')
# largest connected subgraphs
...
smap = smopy.Map(pos0, pos1, z=7, margin=.1)
...
x, y = smap.to_pixels(linepath[:,1], linepath[:,0])
